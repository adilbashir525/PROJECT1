...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const employmentHistory = [
        { id: 1, title: 'Cloud Engineer INTERM', company: 'HILLCREST ', years: '2024 - Present', description: '50 HOURS OF HANDS ON TRAINING WITH AWS ALONG WITH SEVREAL AWS PROJECT' },
        { id: 2, title: 'SALES EXECUTIVE', company: 'PRIDE PRODUCTS', years: '2019 - 2023', description: 'Provide consultation to NYC public sector customer' },
